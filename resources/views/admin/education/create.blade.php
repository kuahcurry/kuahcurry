...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <form action="{{ route('admin.education.store') }}" method="POST" class="bg-white rounded-2xl border border-[#E8E5DC] p-6 sm:p-10 space-y-8 shadow-xs">
        @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-5 p-5 rounded-xl bg-[#FAF9F6] border border-[#E8E5DC]">
                    ...
                    <div>
                        ...
                        <input type="text" name="degree" value="{{ old('degree') }}" required placeholder="e.g. Bachelor of Science in Computer Science" class="w-full px-3.5 py-2.5 rounded-lg bg-white border border-[#D6D3D1] text-sm text-[#1C1917] focus:ring-1 focus:ring-[#1C1917] outline-none">
                    </div>

                    <div>
                        <label class="block text-xs font-mono uppercase tracking-wider text-[#78716C] mb-1.5 font-semibold">Field of Study *</label>
                        <input type="text" name="field_of_study" value="{{ old('field_of_study') }}" required placeholder="e.g. Distributed Computing & Systems" class="w-full px-3.5 py-2.5 rounded-lg bg-white border border-[#D6D3D1] text-sm text-[#1C1917] focus:ring-1 focus:ring-[#1C1917] outline-none">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3" placeholder="Summary of focus areas, thesis topic, and coursework..." class="w-full px-3.5 py-2.5 rounded-lg bg-white border border-[#D6D3D1] text-sm text-[#1C1917] focus:ring-1 focus:ring-[#1C1917] outline-none leading-relaxed">{{ old('description') }}</textarea>
                    </div>

                    <div>
                        <label class="block text-xs font-mono uppercase tracking-wider text-[#78716C] mb-1.5 font-semibold">Achievements &amp; Honors</label>
                        <textarea name="achievements" rows="4" placeholder="Enter each honor or achievement on a new line..." class="w-full px-3.5 py-2.5 rounded-lg bg-white border border-[#D6D3D1] text-sm text-[#1C1917] focus:ring-1 focus:ring-[#1C1917] outline-none leading-relaxed">{{ old('achievements') }}</textarea>
                ...
                <div class="space-y-5 p-5 rounded-xl bg-[#FAF9F6] border border-[#E8E5DC]">
                    ...
                    <div>
                        ...
                        <input type="text" name="degree_id" value="{{ old('degree_id') }}" placeholder="cth. Sarjana Ilmu Komputer" class="w-full px-3.5 py-2.5 rounded-lg bg-white border border-[#D6D3D1] text-sm text-[#1C1917] focus:ring-1 focus:ring-[#1C1917] outline-none">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="field_of_study_id" value="{{ old('field_of_study_id') }}" placeholder="cth. Sistem Komputasi Terdistribusi" class="w-full px-3.5 py-2.5 rounded-lg bg-white border border-[#D6D3D1] text-sm text-[#1C1917] focus:ring-1 focus:ring-[#1C1917] outline-none">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description_id" rows="3" placeholder="Ringkasan fokus keilmuan, topik tugas akhir, atau konsentrasi studi..." class="w-full px-3.5 py-2.5 rounded-lg bg-white border border-[#D6D3D1] text-sm text-[#1C1917] focus:ring-1 focus:ring-[#1C1917] outline-none leading-relaxed">{{ old('description_id') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="achievements_id" rows="4" placeholder="Tuliskan setiap prestasi per baris baru..." class="w-full px-3.5 py-2.5 rounded-lg bg-white border border-[#D6D3D1] text-sm text-[#1C1917] focus:ring-1 focus:ring-[#1C1917] outline-none leading-relaxed">{{ old('achievements_id') }}</textarea>
