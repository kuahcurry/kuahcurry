        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
            <div class="max-w-2xl">
                ...
                <p class="text-[#57534E] text-base mt-2 leading-relaxed">
                    Production software architectures, developer platforms, and open-source tools. Each project includes source repository and live application links.
                </p>
            </div>
            ...
            <div class="mt-6 md:mt-0">
                <md-chip-set class="flex flex-wrap gap-2">
                    <md-filter-chip label="All Works" selected class="project-filter-chip" data-category="all"></md-filter-chip>
            ...
            @forelse($projects as $proj)
                ...
                >
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between space-y-4">
                        ...
                        <!-- Action Links: Git Repo & Live Website (Requirement 4) -->
                        <div class="pt-4 border-t border-[#F4F2EB] flex items-center justify-between gap-3">
                            ...
                            @else
                                <span class="flex-1 text-center text-xs text-[#78716C] font-mono italic">Private Repo</span>
                            @endif
