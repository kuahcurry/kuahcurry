...
class PortfolioSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $skills = [
            ...
            ['name' => 'PHP 8.x', 'name_id' => 'PHP 8.x', 'type' => 'technical', 'category' => 'programming_language', 'proficiency' => 96, 'icon' => 'code', 'sort_order' => 1],
            ['name' => 'TypeScript / JavaScript', 'name_id' => 'TypeScript / JavaScript', 'type' => 'technical', 'category' => 'programming_language', 'proficiency' => 92, 'icon' => 'javascript', 'sort_order' => 2],
            ['name' => 'SQL (PostgreSQL / MySQL)', 'name_id' => 'SQL (PostgreSQL / MySQL)', 'type' => 'technical', 'category' => 'programming_language', 'proficiency' => 90, 'icon' => 'database', 'sort_order' => 3],
            ['name' => 'Python', 'name_id' => 'Python', 'type' => 'technical', 'category' => 'programming_language', 'proficiency' => 84, 'icon' => 'terminal', 'sort_order' => 4],
            ['name' => 'Go', 'name_id' => 'Go', 'type' => 'technical', 'category' => 'programming_language', 'proficiency' => 78, 'icon' => 'speed', 'sort_order' => 5],
            ['name' => 'HTML5 & Modern CSS', 'name_id' => 'HTML5 & CSS Modern', 'type' => 'technical', 'category' => 'programming_language', 'proficiency' => 95, 'icon' => 'html', 'sort_order' => 6],

            // Frameworks (Technical)
            ['name' => 'Laravel Framework', 'name_id' => 'Framework Laravel', 'type' => 'technical', 'category' => 'framework', 'proficiency' => 98, 'icon' => 'layers', 'sort_order' => 1],
            ['name' => 'Tailwind CSS', 'name_id' => 'Tailwind CSS', 'type' => 'technical', 'category' => 'framework', 'proficiency' => 96, 'icon' => 'style', 'sort_order' => 2],
            ['name' => 'Material Web Components (M3)', 'name_id' => 'Material Web Components (M3)', 'type' => 'technical', 'category' => 'framework', 'proficiency' => 92, 'icon' => 'widgets', 'sort_order' => 3],
            ['name' => 'Vue.js / React', 'name_id' => 'Vue.js / React', 'type' => 'technical', 'category' => 'framework', 'proficiency' => 88, 'icon' => 'view_quilt', 'sort_order' => 4],
            ['name' => 'Alpine.js', 'name_id' => 'Alpine.js', 'type' => 'technical', 'category' => 'framework', 'proficiency' => 90, 'icon' => 'bolt', 'sort_order' => 5],
            ['name' => 'Livewire / Inertia.js', 'name_id' => 'Livewire / Inertia.js', 'type' => 'technical', 'category' => 'framework', 'proficiency' => 89, 'icon' => 'sync_alt', 'sort_order' => 6],

            // Databases (Technical)
            ['name' => 'PostgreSQL', 'name_id' => 'PostgreSQL', 'type' => 'technical', 'category' => 'database', 'proficiency' => 92, 'icon' => 'storage', 'sort_order' => 1],
            ['name' => 'MySQL / MariaDB', 'name_id' => 'MySQL / MariaDB', 'type' => 'technical', 'category' => 'database', 'proficiency' => 90, 'icon' => 'table_chart', 'sort_order' => 2],
            ['name' => 'SQLite', 'name_id' => 'SQLite', 'type' => 'technical', 'category' => 'database', 'proficiency' => 95, 'icon' => 'folder_zip', 'sort_order' => 3],
            ['name' => 'Redis (Cache & Queues)', 'name_id' => 'Redis (Cache & Antrean Cepat)', 'type' => 'technical', 'category' => 'database', 'proficiency' => 91, 'icon' => 'memory', 'sort_order' => 4],

            // Tools & Architecture (Technical)
            ['name' => 'Docker & Containerization', 'name_id' => 'Docker & Kontainerisasi', 'type' => 'technical', 'category' => 'tools', 'proficiency' => 88, 'icon' => 'inventory_2', 'sort_order' => 1],
            ['name' => 'Git & GitHub Workflows', 'name_id' => 'Alur Kerja Git & GitHub', 'type' => 'technical', 'category' => 'tools', 'proficiency' => 95, 'icon' => 'commit', 'sort_order' => 2],
            ['name' => 'CI/CD Pipelines (GitHub Actions)', 'name_id' => 'Pipeline CI/CD (GitHub Actions)', 'type' => 'technical', 'category' => 'tools', 'proficiency' => 89, 'icon' => 'published_with_changes', 'sort_order' => 3],
            ['name' => 'RESTful API & GraphQL Design', 'name_id' => 'Perancangan RESTful API & GraphQL', 'type' => 'technical', 'category' => 'tools', 'proficiency' => 94, 'icon' => 'hub', 'sort_order' => 4],
            ['name' => 'AWS Cloud Services', 'name_id' => 'Layanan Cloud AWS', 'type' => 'technical', 'category' => 'tools', 'proficiency' => 84, 'icon' => 'cloud_queue', 'sort_order' => 5],
            ['name' => 'Automated Testing (Pest / PHPUnit)', 'name_id' => 'Pengujian Otomatis (Pest / PHPUnit)', 'type' => 'technical', 'category' => 'tools', 'proficiency' => 92, 'icon' => 'fact_check', 'sort_order' => 6],
